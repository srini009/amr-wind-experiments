#!/bin/bash
export AMS_SERVER_ADDR_FILE=/home/sramesh/VIZ_SERVICE/experiments/amr_wind_inputs_1/C13/addr.mercury
export AMS_NODE_ADDR_FILE=/home/sramesh/VIZ_SERVICE/experiments/amr_wind_inputs_1/C13/nodes.mercury
