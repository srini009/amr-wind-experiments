#!/bin/bash
export AMS_SERVER_ADDR_FILE=/home/sramesh/VIZ_SERVICE/experiments/eager_360/addr.mercury
export AMS_NODE_ADDR_FILE=/home/sramesh/VIZ_SERVICE/experiments/eager_360/nodes.mercury
