#!/bin/bash
export AMS_SERVER_ADDR_FILE=$HOME/serviz-experiments/configurations_C1_to_C10/C4/addr.mercury
export AMS_NODE_ADDR_FILE=$HOME/serviz-experiments/configurations_C1_to_C10/C4/nodes.mercury
