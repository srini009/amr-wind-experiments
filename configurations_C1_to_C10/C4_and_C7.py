...
input_staging_arr = [
        {'source': 'pilot:///mediumlarge360.damBreak.i', 
            'target': 'task:///mediumlarge360.damBreak.i', 
            'action': rp.LINK},
...
if __name__ == '__main__':
    ...
    try:
        ...
        tmgr.add_pilots(pmgr.submit_pilots(rp.PilotDescription({
            ...
            'runtime': RUN_TIME,
            'input_staging': ['/home/sramesh/VIZ_SERVICE/experiments/amr_wind_inputs_1/mediumlarge360.damBreak.i',
        ...
        for _num in range(1):
            tds.append(rp.TaskDescription({
                ...
                'pre_exec': ['source /home/sramesh/VIZ_SERVICE/theta_sourceme.sh', 'source /home/sramesh/VIZ_SERVICE/experiments/amr_wind_inputs_1/sourcemeeager360.sh'],
        ...
        for _num in range(NUM_TASKS):
            ...
            server_instance_id = 'export AMS_SERVER_INSTANCE_ID=0'
            tds.append(rp.TaskDescription({
                'cpu_processes': 360, 
                'cpu_threads': 1,
                'cpu_process_type': rp.MPI,
                'pre_exec': ['source ~/VIZ_SERVICE/theta_sourceme.sh', 'source ~/VIZ_SERVICE/experiments/amr_wind_inputs_1/sourcemeeager360.sh', 'source ~/VIZ_SERVICE/experiments/amr_wind_inputs_1/checkserver.sh', task_id, server_instance_id],
                'executable': '/home/sramesh/VIZ_SERVICE/AMR_WIND_INSTALL/bin/amr_wind',
                'stdout': 'STDOUT',
                'arguments': ['mediumlarge360.damBreak.i'],
                'input_staging': input_staging_arr}))
