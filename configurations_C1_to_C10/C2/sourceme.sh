#!/bin/bash
export AMS_SERVER_ADDR_FILE=$HOME/serviz-experiments/configurations_C1_to_C10/C2/addr.mercury
export AMS_NODE_ADDR_FILE=$HOME/serviz-experiments/configurations_C1_to_C10/C2/nodes.mercury
...
export AMS_NUM_SERVERS_PER_INSTANCE=30
export AMS_NUM_SERVER_INSTANCES=2
