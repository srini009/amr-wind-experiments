#!/bin/bash
export AMS_SERVER_ADDR_FILE=$HOME/serviz-experiments/configurations_C11_to_C30/C22/addr.mercury
export AMS_NODE_ADDR_FILE=$HOME/serviz-experiments/configurations_C11_to_C30/C22/nodes.mercury
