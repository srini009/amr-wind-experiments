#!/bin/bash
export AMS_SERVER_ADDR_FILE=$HOME/serviz-experiments/configurations_C11_to_C30/C21/addr.mercury
export AMS_NODE_ADDR_FILE=$HOME/serviz-experiments/configurations_C11_to_C30/C21/nodes.mercury
