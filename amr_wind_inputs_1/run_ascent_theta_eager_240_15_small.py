    ...
    try:
        ...
        for _num in range(NUM_TASKS):
            ...
            tds.append(rp.TaskDescription({
                ...
                'cpu_threads': 1,
                'cpu_process_type': rp.MPI,
                'pre_exec': ['sleep 15', 'source ~/VIZ_SERVICE/theta_sourceme.sh', 'source ~/VIZ_SERVICE/experiments/amr_wind_inputs_1/sourcemeeager240_15.sh', task_id, server_instance_id],
