...
input_staging_arr = [
        {'source': 'pilot:///mediumlarge.damBreak.i', 
            'target': 'task:///mediumlarge.damBreak.i', 
            'action': rp.LINK},
...
if __name__ == '__main__':
    ...
    try:
        ...
        tmgr.add_pilots(pmgr.submit_pilots(rp.PilotDescription({
            ...
            'runtime': RUN_TIME,
            'input_staging': ['/home/sramesh/VIZ_SERVICE/experiments/amr_wind_inputs_1/mediumlarge.damBreak.i',
        ...
        for _num in range(1):
            tds.append(rp.TaskDescription({
                ...
                'pre_exec': ['source /home/sramesh/VIZ_SERVICE/theta_sourceme.sh', 'source /home/sramesh/VIZ_SERVICE/experiments/amr_wind_inputs_1/sourcemelazy.sh'],
        ...
        for _num in range(NUM_TASKS):
            ...
            tds.append(rp.TaskDescription({
                ...
                'cpu_threads': 1,
                'cpu_process_type': rp.MPI,
                'pre_exec': ['sleep 15', 'source ~/VIZ_SERVICE/theta_sourceme.sh', 'source ~/VIZ_SERVICE/experiments/amr_wind_inputs_1/sourcemelazy.sh', task_id, server_instance_id],
                'executable': '/home/sramesh/VIZ_SERVICE/AMR_WIND_INSTALL/bin/amr_wind',
                'stdout': 'STDOUT',
                'arguments': ['mediumlarge.damBreak.i'],
                'input_staging': input_staging_arr}))
